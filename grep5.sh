...
# task is to grep out and output only those credit card numbers which have two
# or more consecutive occurences of the same digit (which may be separated by a
# space, if they are in different segments). Assume that the credit card
...
# been highlighted in box brackets. The last case does not have any repeated
# digits: 1234 5678 910[1] [1]234
