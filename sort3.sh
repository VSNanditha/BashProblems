...
# There will be no extra characters other than the number or the newline at the
# end of each line. Sort the lines in ascending order - so that the first line
# holds the numerically smallest number, and the last line holds the numerically
# largest number.
#
# Input Format
# A text file where each line contains a positive number (less than 100) as
# described above.
#
# Output Format
